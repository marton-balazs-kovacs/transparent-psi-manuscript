...
The study currently has 33552 erotic trials gathered from a total of
1874 participants. There has been 25 incomplete study sessions so far
resulting in a total of 180 (0.54%) missing data points due to
incomplete sessions. We observed a total of 49.94% successful guesses
within 33552 erotic trials (posterior mode = 50.08%, posterior 90% HDI =
49.66%, 50.53%).
