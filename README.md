...
The study currently has 29962 erotic trials gathered from a total of
1673 participants. There has been 22 incomplete study sessions so far
resulting in a total of 152 (0.51%) missing data points due to
incomplete sessions. We observed a total of 49.91% successful guesses
within 29962 erotic trials (posterior mode = 50.07%, posterior 90% HDI =
49.61%, 50.53%).
