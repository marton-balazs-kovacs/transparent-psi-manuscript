...
The study currently has 28994 erotic trials gathered from a total of
1619 participants. There has been 21 incomplete study sessions so far
resulting in a total of 148 (0.51%) missing data points due to
incomplete sessions. We observed a total of 49.87% successful guesses
within 28994 erotic trials (posterior mode = 50.03%, posterior 90% HDI =
49.56%, 50.49%).
