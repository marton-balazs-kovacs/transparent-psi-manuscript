...
The study currently has 33716 erotic trials gathered from a total of
1883 participants. There has been 24 incomplete study sessions so far
resulting in a total of 178 (0.53%) missing data points due to
incomplete sessions. We observed a total of 49.96% successful guesses
within 33716 erotic trials (posterior mode = 50.09%, posterior 90% HDI =
49.66%, 50.53%).
